...
import Arma.Arco;
import Arma.Martelo;
import Arma.PoMagico;

import Escudo.Escudo;
import Escudo.EscudoFerro;
import Escudo.EscudoMadeira;
import Escudo.EscudoMagico;

import Personagens.Personagem;
import Personagens.Arqueiro;
import Personagens.Feiticeira;
import Personagens.Ogro;
...
class App {
  public static void main(String[] args) {
    ...
    for (Personagem p : personagens)
      System.out.println(p.getSaude() == 100);
    for (Personagem p : personagens)
      System.out.println(p.estaVivo() == true);
    for (Personagem p : personagens)
      System.out.println(p.getArmaPrincipal() == null);
    for (Personagem p : personagens)
      System.out.println(p.getArmaSecundaria() == null);
    for (Personagem p : personagens)
      System.out.println(p.getEscudo() == null);
