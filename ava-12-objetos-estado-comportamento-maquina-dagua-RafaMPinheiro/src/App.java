class App {
  public static void main(String[] args) {
    ...
    // // As três linhas a seguinte não devem compilar pois estes atributos devem
    // ser
    // // imutáveis:
    ...
    System.out.println(maquininha.agua() == 1000); // mL
    ...
    try {
      ...
      System.out.println(false); // esta linha não deve ser executada
      System.out.println(maqinvalida);
    ...
    try { // servindo enquanto houver água até causa estado inválido
      ...
      System.err.println(e.getMessage() + " " + maquinao.agua());
    }
